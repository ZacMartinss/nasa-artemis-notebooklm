# 🚀 NASA Artemis e o Futuro da Exploração Lunar

## 📖 Sobre o Projeto

Este projeto foi desenvolvido como parte do desafio prático da DIO utilizando a ferramenta **NotebookLM**, uma plataforma baseada em Inteligência Artificial para organização, estudo e construção de conhecimento.

O tema escolhido foi a evolução da exploração espacial humana, com foco na NASA, no Programa Artemis, na futura base lunar permanente e nos preparativos para missões tripuladas a Marte.

Além de atender aos requisitos do desafio, este projeto busca demonstrar como a IA pode ser utilizada como uma ferramenta de aprendizagem ativa, transformando diversas fontes de informação em uma base estruturada de conhecimento.
...
O Programa Apollo tinha como objetivo principal pousar seres humanos na Lua e retorná-los à Terra em segurança.

O Programa Artemis possui uma abordagem diferente: estabelecer uma presença humana sustentável na Lua, utilizando o Polo Sul Lunar como campo de testes para futuras missões a Marte.
...
Durante o desenvolvimento deste projeto foram utilizados diversos recursos nativos do NotebookLM:
...
✅ Cartões Didáticos (65 flashcards)
...
O NotebookLM demonstrou ser uma ferramenta poderosa para aprendizado ativo, permitindo reunir fontes diversas, gerar resumos, construir mapas mentais, criar materiais de revisão e organizar conhecimento de forma estruturada.

Através do estudo do Programa Apollo, do Programa Artemis e dos planos para uma presença humana permanente na Lua, foi possível compreender como a exploração espacial evoluiu e como a humanidade está se preparando para dar o próximo grande passo: a chegada a Marte.
